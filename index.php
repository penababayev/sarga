...
<head>
    <?php include("./sameparts/head.php") ?>
</head>
...
<body>    
    ...
    <?php include("./sameparts/canvas_menus.php") ?>
    <!--====== OFFCANVAS MENU PART ENDS ======-->
   
    <!--====== PART START ======-->
    <?php include("./sameparts/header.php") ?>
    <!--====== PART ENDS ======-->
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="appie-hero-content">
                        <span>Sarga Online Söwda Platformasyna Hoşgeldiňiz</span>
                        <h1 class="appie-title">Ýurdumyzyň ähli künjegine tizlenir </h1>
                        <p>Hanky panky lavatory up the duff jolly good cack brolly is chinwag zonked happy days sloshed.</p>
                        <ul>
                            <li><a href="#"><i class="fab fa-apple"></i> iOS üçin göçürip al</a></li>
                            <li><a class="item-2" href="#"><i class="fab fa-google-play"></i> Android üçin göçürip al</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="appie-hero-thumb">
                        ...
                        <div class="thumb-2 wow animated fadeInRight" data-wow-duration="2000ms" data-wow-delay="300ms">
    ...
    <section id="service" class="appie-service-area pt-90 pb-100" id="service">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="appie-section-title text-center">
                        <h3 class="appie-title">Ulanyjylaryň isleglerini <br> kanagatlandyrjak ýagdaýda işlenip düzüldi.</h3>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="appie-single-service text-center mt-30 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="200ms">
                        ...
                        <h4 class="appie-title">Ulanmak aňsat</h4>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="appie-single-service text-center mt-30 item-2 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="400ms">
                        ...
                        <h4 class="appie-title">Doly işleýär</h4>
                        <p>Mucker plastered bugger all mate morish are.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="appie-single-service text-center mt-30 item-3 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="600ms">
                        ...
                        <h4 class="appie-title">Ygtybarly</h4>
                        <p>Mucker plastered bugger all mate morish are.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="appie-single-service text-center mt-30 item-4 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="800ms">
                        ...
                        <h4 class="appie-title">Goldawly</h4>
                        <p>Mucker plastered bugger all mate morish are.</p>
                    </div>
                </div>
            </div>
    ...
    <section id="features" class="appie-features-area pt-100" id="features">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-3">
                    <div class="appie-features-tabs-btn">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false"><i class="fas fa-exclamation-triangle"></i> Terminal arkaly söwda</a>
                            <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false"><i class="fas fa-bell"></i> Mugt gowşurmak</a>
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="appie-features-content wow animated fadeInRight" data-wow-duration="2000ms" data-wow-delay="600ms">
                                        <span>Türkmenistan derejesinde</span>
                                        <h3 class="title">Ilkinji bolup <br> başaran döwrebap üýtgeşmelerimiz</h3>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="appie-traffic-title">
                        <span>Tizlik ve kalite</span>
                        <h3 class="title">Bla bla bla.</h3>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="appie-traffic-service item-3">
                                ...
                                <h5 class="title">Nlasd,askfn,m</h5>
                                <p>Mucker plastered bugger all mate morish are.</p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
    ...
    <section class="appie-showcase-area ">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="appie-section-title text-center">
                        <h3 class="appie-title">Platformanyň programma witrinasy</h3>
    ...
    <section class="appie-faq-area pb-95">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="appie-section-title text-center">
                        <h3 class="appie-title">Ýygy-ýygydan berilýän soraglar</h3>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="accrodion active ">
                                <div class="accrodion-inner">
                                    <div class="accrodion-title">
                                        <h4>Bu Platforma haçan ulanylyşa girizilýär?</h4>
                                    </div>
                ...
                <div class="col-lg-12">
                    <div class="faq-text text-center pt-40">
                        <p>Jogap tapyp bilmediňizmi? <a href="mailto:demo@gmail.com">Bize e-poçta iberiň</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="appie-team-area pt-90 pb-100">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="appie-section-title text-center">
                        <h3 class="appie-title">Toparymyzyň agzalary bilen duşuşyň</h3>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="appie-team-item mt-30 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="200ms">
                        ...
                        <div class="content text-center">
                            <h5 class="title">Gurmanmyrat Ýazmyradow</h5>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="appie-team-item mt-30 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="400ms">
                        ...
                        <div class="content text-center">
                            <h5 class="title">Ýakup Amanow</h5>
                            <span>CEO-Founder</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="appie-team-item mt-30 wow animated fadeInUp" data-wow-duration="2000ms" data-wow-delay="600ms">
                        ...
                        <div class="content text-center">
                            <h5 class="title">Arslan Agaýew</h5>
                            <span>CEO-Founder</span>
                        </div>
                    </div>
                </div>
